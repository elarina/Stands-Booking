...
LiveReload for FireFox (плагин для автоматического обновления Web-страниц при изменении шаблонов страниц в среде разработки) - https://addons.mozilla.org/ru/firefox/addon/livereload-web-extension/
